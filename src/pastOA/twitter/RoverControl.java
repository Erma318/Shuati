...
public class RoverControl {
    private static int roverMove(int matrixSize, String[] cmds) {
        // initialize
        int[] start = {0, 0};
        ...
        for (String cmd : cmds) {
            ...
            // check validation
            if (start[0] + operation[0] < 0 || start[0] + operation[0] >= matrixSize
                    || start[1] + operation[1] < 0 || start[1] + operation[1] >= matrixSize) {
                continue;
            } else {
